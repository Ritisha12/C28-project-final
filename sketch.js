...
function setup() {
	...
	mango1=new Mango(580,200,30)//radius is actually 25 for all mangoes
...
if(distance<=mango.radius+stone.radius){
 ...
 //pls implement the attach() to bring the stone back to the hand on press of space. string=new String(stone.body,{x:190,y:330})
 //==>>> revert to the original value as it was there in your code. mango.js(line #21):-image(this.image,0,0,this.radius*2,this.radius*2)